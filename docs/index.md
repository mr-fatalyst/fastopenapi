!!! warning "Release Candidate — v1.0.0rc2"
    You are viewing the documentation for **v1.0.0rc2** (release candidate). The API is stable, but minor changes may occur before the final release. The last stable version is available [here](https://fastopenapi.fatalyst.dev/0.7/).
...
FastOpenAPI is currently a **release candidate** (version 1.0.0rc2). The API is stable, but minor changes may occur before the 1.0.0 release. We welcome feedback and contributions to help improve the library.
